...
public class booking extends JFrame implements ActionListener
{
	...
	public booking()
	{
		...
		ImageIcon lbimg = new ImageIcon("C:/Java/Project%201/ProjectBookmytickect/src/img/lblogo.gif");
		lblbl = new JLabel (lbimg);
		ImageIcon mbimg = new ImageIcon("C:/Java/Project%201/ProjectBookmytickect/src/img/lblogo.gif");
		mblbl = new JLabel (mbimg);
		ImageIcon rbimg = new ImageIcon("C:/Java/Project%201/ProjectBookmytickect/src/img/lblogo.gif");
